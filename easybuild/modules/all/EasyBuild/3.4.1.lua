...
local root = "/home/srinivm/CentOS7/easybuild/software/EasyBuild/3.4.1"

conflict("EasyBuild")

prepend_path("PATH", pathJoin(root, "bin"))
setenv("EBROOTEASYBUILD", root)
setenv("EBVERSIONEASYBUILD", "3.4.1")
setenv("EBDEVELEASYBUILD", pathJoin(root, "easybuild/EasyBuild-3.4.1-easybuild-devel"))
